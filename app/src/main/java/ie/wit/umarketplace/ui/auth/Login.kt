package ie.wit.umarketplace.ui.auth
...
import ie.wit.umarketplace.activities.Home
import ie.wit.umarketplace.databinding.LoginBinding
                ...
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        try {
                            ...
                            Snackbar.make(loginBinding.googleSignInButton, "Authentication Failed.",
                                Snackbar.LENGTH_SHORT).show()
                        }
                        Timber.i("UMarketplace Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
